...
if (isset($_GET['keyWord'])) {
    ...
    $sql_count .= " WHERE book.book_title LIKE '%$keyWord%'";
    $sql .= " WHERE book.book_title LIKE '%$keyWord%'";
}
...
<main class="inner-page-sec-padding-bottom">
    <div class="container">
        <h2><?= $totalLine ?> search results for keyword <b>"<?php echo $keyWord; ?>"</b></h2>
        ...
        <div class="shop-toolbar d-none">
            <div class="row align-items-center">
                <div class="col-xl-6 col-md-4 col-sm-6 mt--10 mt-sm--0">
                    <span class="toolbar-status">
                        <?= $showFrom ?> to <?= $showTo ?> of <?= $totalLine ?>
                        (<?= $totalPage ?> Pages)
                    </span>
                </div>
                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 mt--10 mt-md--0 ">
                        ...
                        <div class="product-card--body">
                            <div class="card-image">
                                <img src=<?php echo "uploads/" . $book['book_image']; ?>
                                    alt="<?php echo $book['book_title']; ?>" width="90%" height="300px"
