...
error_reporting(0);
session_start();
//Check if an admin user logined then allow access home.php (Admin Panel Dashboar)
...
<head>
    ...
    <meta name="author" content="@hoangnxhut">

    <meta name="description" content="Pustok Bookstore Admin Panel">
    ...
    <div class="container" style="margin-top:30px">
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                <h1 class="text-center">Pustok Bookstore Admin Panel</h1>
